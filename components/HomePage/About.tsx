    ...
    <div className='flex flex-col items-center justify-center font-clashDisplay'>
      <h2 className='text-3xl py-20'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-between bg-white text-black w-full'>
            <div className='flex flex-col gap-8 md:pl-20 px-4 md:px-0 pt-20 pb-10 md:pb-0'>
                <h2>
            ...
            width={1000}
            height={1000}
            className='lg:w-[680px] lg:h-[603px] md:w-[320px] h-[475px] aspect-square'
            />
        </div>
        <div className='flex flex-col md:flex-row items-center justify-between bg-white text-black w-full'>
            <Image
            ...
            width={1000}
            height={1000}
            className='lg:w-[670px] lg:h-[603px] md:w-[320px] h-[475px] aspect-square'
            />
            <div className='flex flex-col gap-8 md:pr-20 px-4 md:px-0 pt-20 pb-10 md:pb-0'>
                <h2>
                    From a studio in London to a global brand with<br />
                    over 400 outlets
                </h2>
        ...
        <div className='bg-white text-black flex flex-col justify-center items-center py-16'>
            <h2 className='text-2xl mb-20'>
                What makes our brand different
            </h2>
            <div className='gap-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-5'>
        ...
        <div className='flex-col items-center justify-center text-black h-[444px] space-y-4 w-full relative hidden md:flex'
        style={{
        ...
        >
            <div className='flex items-center justify-center absolute top-72'>
                <Input
                type='email'
                placeholder='your@email.com'
                className='md:w-[354px] h-[56px] rounded-none'
                />
                <Button className='md:w-[118px] h-[56px] rounded-none bg-[#2A254B]'>
                    Sign up
                </Button>
            </div>
        </div>
        <div className='flex-col justify-center text-white h-[444px] px-5 space-y-4 w-full flex md:hidden'
        style={{
        ...
        >
            ...
            <p>Sign up for our newsletter and recieve exclusive offers on new ranges, sales, pop up stores and more</p>
            <ul className='flex flex-col gap-4'>
                <li className='flex'>
                    <svg className='mt-1 mr-2' width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 0C5.61553 0 4.26216 0.410543 3.11101 1.17971C1.95987 1.94888 1.06266 3.04213 0.532846 4.32122C0.00303298 5.6003 -0.13559 7.00776 0.134506 8.36563C0.404603 9.7235 1.07129 10.9708 2.05026 11.9497C3.02922 12.9287 4.2765 13.5954 5.63437 13.8655C6.99224 14.1356 8.3997 13.997 9.67879 13.4672C10.9579 12.9373 12.0511 12.0401 12.8203 10.889C13.5895 9.73785 14 8.38447 14 7C14 5.14348 13.2625 3.36301 11.9497 2.05025C10.637 0.737498 8.85652 0 7 0ZM6 9.7954L3.5 7.2954L4.2953 6.5L6 8.2046L9.705 4.5L10.5029 5.29295L6 9.7954Z" fill="white"/>
                    </svg>
                    Exclusive offers
                </li>
                <li className='flex'>
